        ...
        <div className='fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex justify-center items-center'>
          <div className='bg-white p-5 md:p-10 rounded'>
            <div className="modal-content flex flex-col justify-items-center items-center ">
              ...
              <img className='h-32 py-3' src='/Images/img27.png' alt='tick logo' />
              <div className='flex text-center w-[29rem]'>
                <p className='text-gray-600 text-wrap font-medium'>The registered University will be approved by the admin and a message will be sent to your mail</p></div>
